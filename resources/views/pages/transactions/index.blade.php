                                ...
                                <tbody>
                                    @forelse ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if($item->transaction_status == 'PENDING')
                                                    <a href="{{ route('transactions.status', $item->id) }}?status=SUCCESS" class="btn btn-sm btn-success">
                                                        <i class="fa fa-check"></i>
                                                    </a>
                                                    <a href="{{ route('transactions.status', $item->id) }}?status=FAILED" class="btn btn-sm btn-danger">
                                                ...
                                                <a href="{{ route('transactions.edit', $item->id) }}" class="btn btn-sm btn-primary">
