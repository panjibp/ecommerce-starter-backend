...
@push('after-script')
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            // Pie chart flotPie1
            var piedata = [
                { label: "{{ $pie['pending'] }} Pendingg", data: [[1,{{ $pie['pending'] }}]], color: '#5c6bc0'},
                { label: "{{ $pie['failed'] }} Gagal", data: [[1,{{ $pie['failed'] }}]], color: '#ef5350'},
                { label: "{{ $pie['success'] }} Sukses", data: [[1,{{ $pie['success'] }}]], color: '#66bb6a'}
            ];
